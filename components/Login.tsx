...
export const Login: React.FC<LoginModalProps> = ({ onClose, t }) => {
        ...
        <>
            ...
            <div className="space-y-4">
                ...
                <button
                    ...
                    onClick={() => alert('Phone authentication is not implemented yet.')}
    ...
    const renderEmailView = () => (
        <div className="animate-fade-in text-start">
            <button onClick={() => { setView('main'); setError(null); }} className="absolute top-4 start-4 text-white/50 hover:text-white transition-colors flex items-center gap-1 text-sm">
            ...
            <div className="flex gap-3 mt-6">
                 <button
                    ...
                    className="w-full py-3 px-4 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                    ...
                    disabled={isSubmitting || !email || !password}
                    className="w-full py-3 px-4 bg-gray-600 text-white font-bold rounded-lg hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
